...
// to multiply to produce it. For example: if num is 24 then you can multiply 8 by 
// 3 which produces 24, so your program should return 2 because there is a total 
// of only 2 digits that are needed. Another example: if num is 90, you can 
