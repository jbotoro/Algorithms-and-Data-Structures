...
// matched brackets. For example: if str is "(()))" then your program should 
// return the number 1. The answer could potentially be 0, and there will always 
// be at least one set of matching brackets in the string.
