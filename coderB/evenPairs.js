...
// determine if a pair of adjacent even numbers exists anywhere in the string. If 
// a pair exists, return the string true, otherwise return false. For example: 
...
function EvenPairs(str) { 
    ...
    return str.split(/\D/gi).some(pairs => pairs % 2 === 0 && pairs.toString().length > 1);
